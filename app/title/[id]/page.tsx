...
export async function generateMetadata({ params }: { params: { id: string } }) {
  ...
  return {
    title: `${titleData.title || titleData.name} (${titleData.year}) - FreeStream World`,
    description: titleData.overview?.slice(0, 160) || 'Watch this title for free on official legal platforms.',
    openGraph: {
      images: titleData.backdrop_path 
        ? [`${TMDB_IMAGE_BASE}/original${titleData.backdrop_path}`] 
        : ['/icon-512.png'],
    },
  };
}
