...
export async function GET(request: Request) {
  ...
  console.log(`🚀 STARTING ${isFullRefresh ? 'FULL MONTHLY REBUILD (40 calls — cached 30 days)' : 'SMART DAILY (4 calls)'}...`);
  ...
  // Save previous catalog — now 30 days (exactly what you asked)
  ...
  return NextResponse.json({
    ...
    message: isFullRefresh ? 'Full monthly catalog rebuilt (40 calls — cached 30 days)' : 'Smart daily refresh complete (4 calls)'
  });
}
