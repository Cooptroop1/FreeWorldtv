...
const liveChannels = [
  ...
  { id: 4, name: 'Big Buck Bunny HLS Demo (Test)', category: 'Test', url: 'https://devstreaming-cdn.apple.com/videos/streaming/examples/img_bipbop_adv_example_ts/master.m3u8' },
